            ...
            <div class="content">
				...
				<div class="content-padding">
                	<div id="addkategori" style="display:none">
                     <form action="<?php echo site_url(); ?>admin/useradmin/<?php echo $action; ?>/<?php echo $MENU_ID;?>/<?php echo $ParentNumber;?>/<?php echo $id_menu;?>" class="contact" Name='img_form' id="img_form" method='post'>
                ...
                <div id="editMenu" style="display:none">
                                ...
                                <tr>
                                    ...
                                    <td align=left>
                                    	<a href="<?=base_url();?>admin/useradmin/subsubsubmenusetting/<?=$MENU_ID;?>/<?=$ParentNumber;?>/<?php echo $id_menu;?>/<?=$DataView[$a]['MenuID'];?>" class="text-blue">
                                    	<?=$DataView[$a]['MenuName'];?>
                                        </a>
                                    </td>
                                    <td align=left>
