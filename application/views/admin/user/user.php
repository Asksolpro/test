              ...
              <table id="example1" class="table table-bordered table-striped">
							...
							for($a=0; $a < count($data_user); $a++)
							{
								...
								<tr>
									...
									<td>'.$name_group.'</td>
									<td>
									  <a href="'.base_url().'admin/group/reset_password/'.$menuid.'/'.$id_group.'/'.$ID.'" class="btn text-yellow" onClick="return confirm(\'Apakah anda yakin untuk merubah password user admin ini?\')"> Reset Password </a> 
									</td>
									<td>
          ...
          <div class="modal-content" style="z-index:999">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Tambah User Baru</h4>
                ...
                <form action="<?php echo base_url();?>admin/useradmin/createNewUser/<?php echo $menuid;?>" method="post" enctype="multipart/form-data">
