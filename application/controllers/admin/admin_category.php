...
class admin_category extends authcontroller{
	...
	function index($MENU_ID){
		...
		$config['base_url']	 = base_url().'admin/master/product_category/'.$MENU_ID;
	...
	function update_sort($MENU_ID)
	{
		...
		redirect('admin/admin_category/index/'.$MENU_ID);
